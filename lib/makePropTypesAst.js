...
var _babelTemplate = require('@nkduy/babel-template');
...
function makePropType(data, isExact) {
  ...
  if (USE_PROPTYPES_PACKAGE) {
    ...
    dulcetNode = t.callExpression(t.identifier('require'), [(0, _util.makeLiteral)('dulcet')]);
    node = t.memberExpression(dulcetNode, t.identifier('PropTypes'));
    isRequired = true;
  }
